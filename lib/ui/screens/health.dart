...
import 'package:aware/health/self_assess.dart';
import 'package:aware/health/chat.dart';
import 'package:aware/health/chat_chip.dart';
import 'package:aware/health/chat_data.dart';
        ...
        _chatFlow.add(
          ChatChip(
            ...
            problemscallback: (value) {
              ...
              print('Problem Count = $problemsCount');
            },
            isCompletedCallBack: () {
